...
{{--                    <div wire:key="{{ $softwareType_name }}" class="modal-content">--}}
                    ...
                    <div class="px-2 pt-4 sm:px-6">
                        ...
                        <div class="p-4 flex justify-between gap-x-5">
                            ...
                            <!-- Questions Section Billing Software -->


{{--                            <div class="p-4 space-y-4 border rounded-lg">--}}

{{--                                <div class=" block my-4"> <strong>Selected Software Type: </strong>{{ $softwareType_name }} </div>--}}

{{--                            <div>--}}
{{--                                @if ($softwareType_name === 'Billing Software')--}}
{{--                                    <label class="block text-lg font-semibold">Questions</label>--}}

{{--                                    <!-- Question 1 -->--}}
{{--                                    <div>--}}
{{--                                        <label for="question1" class="block text-sm font-medium">--}}
{{--                                            1. How are you currently managing your billing process?--}}
{{--                                        </label>--}}
...
{{--                                    <!-- Question 2 -->--}}
{{--                                    <div>--}}
{{--                                        <label for="question2" class="block text-sm font-medium">--}}
{{--                                            2. Are you using any software for billing, or it is managed manually?--}}
{{--                                        </label>--}}
...
{{--                                    <!-- Question 3 -->--}}
{{--                                    <div>--}}
{{--                                        <label for="question3" class="block text-sm font-medium">--}}
{{--                                            3. What features do you need in your billing system?--}}
{{--                                        </label>--}}
...
{{--                                    <!-- Question 4 -->--}}
{{--                                    <div>--}}
{{--                                        <label for="question4" class="block text-sm font-medium">--}}
{{--                                            4. How Many users will need to access to the software?--}}
{{--                                        </label>--}}
...
{{--                                    <!-- Question 5 -->--}}
{{--                                    <div>--}}
{{--                                        <label for="question5" class="block text-sm font-medium">--}}
{{--                                            5. Do you need support for multiple currencies?--}}
{{--                                        </label>--}}
...
{{--                                    <!-- Question 6 -->--}}
{{--                                    <div>--}}
{{--                                        <label for="question6" class="block text-sm font-medium">--}}
...
{{--                                    <!-- Question 7 -->--}}
{{--                                    <div>--}}
{{--                                        <label for="question7" class="block text-sm font-medium">--}}
{{--                                            7.Do you want implement immediately or Timeline?--}}
{{--                                        </label>--}}
...
{{--                                @endif--}}
{{--                            </div>--}}
{{--<!-------------------- Portfolio Software Questions --------------------------->--}}
{{--                                <div>--}}
{{--                                    @if ($softwareType_name === 'Portfolio Software')--}}
{{--                                        <label class="block text-lg font-semibold">Questions</label>--}}

{{--                                        <!-- Question 1 -->--}}
{{--                                        <div>--}}
{{--                                            <label for="question1" class="block text-sm font-medium">--}}
{{--                                                1. How are you currently managing your portfolio?--}}
{{--                                            </label>--}}
{{--                                            <input type="text" id="question1" wire:model="questions.question1"--}}
{{--                                                   class="w-full form-input">--}}
{{--                                            @error('questions.question1')--}}
...
{{--                                        <div>--}}
{{--                                            <label for="question2" class="block text-sm font-medium">--}}
{{--                                                2. Are you using any software for portfolio management, or is it managed manually?--}}
{{--                                            </label>--}}
{{--                                            <input type="text" id="question2" wire:model="questions.question2"--}}
{{--                                                   class="w-full form-input">--}}
{{--                                            @error('questions.question2')--}}
...
{{--                                        <div>--}}
{{--                                            <label for="question3" class="block text-sm font-medium">--}}
{{--                                                3.What features do you need in your portfolio system?--}}
{{--                                            </label>--}}
{{--                                            <textarea id="question3" wire:model="questions.question3" rows="2"--}}
{{--                                                      class="w-full form-textarea"></textarea>--}}
{{--                                            @error('questions.question3')--}}
...
{{--                                        <div>--}}
{{--                                            <label for="question4" class="block text-sm font-medium">--}}
{{--                                                4.'How many items do you manage?--}}
{{--                                            </label>--}}
{{--                                            <input type="text" id="question4" wire:model="questions.question4"--}}
{{--                                                   class="w-full form-input">--}}
{{--                                            @error('questions.question4')--}}
...
{{--                                        <div>--}}
{{--                                            <label for="question5" class="block text-sm font-medium">--}}
{{--                                                5.'Do you need integration with financial platforms?--}}
{{--                                            </label>--}}
{{--                                            <input type="text" id="question5" wire:model="questions.question5"--}}
{{--                                                   class="w-full form-input">--}}
{{--                                            @error('questions.question5')--}}
...
{{--                                        <div>--}}
{{--                                            <label for="question7" class="block text-sm font-medium">--}}
{{--                                                7.Do you want implement immediately or Timeline?</label>--}}
{{--                                            <input type="text" id="question7" wire:model="questions.question7"--}}
{{--                                                   class="w-full form-input">--}}
{{--                                            @error('questions.question7')--}}
{{--                                            <span class="text-xs text-red-500">{{$message}}</span>--}}
...
{{--<!----- Business Software Questions ----------------------------------------------------------------------->--}}
{{--                                <div>--}}
{{--                                    @if ($softwareType_name === 'Business Software')--}}
{{--                                        <label class="block text-lg font-semibold">Questions</label>--}}

{{--                                        <!-- Question 1 -->--}}
{{--                                        <div>--}}
{{--                                            <label for="question1" class="block text-sm font-medium">--}}
{{--                                                1.How are you currently managing your business operations??--}}
{{--                                            </label>--}}
{{--                                            <input type="text" id="question1" wire:model="questions.question1"--}}
{{--                                                   class="w-full form-input">--}}
{{--                                            @error('questions.question1')--}}
...
{{--                                        <div>--}}
{{--                                            <label for="question2" class="block text-sm font-medium">--}}
{{--                                                2. Are you using any software for business management, or is it managed manually?--}}
{{--                                            </label>--}}
{{--                                            <input type="text" id="question2" wire:model="questions.question2"--}}
{{--                                                   class="w-full form-input">--}}
{{--                                            @error('questions.question2')--}}
...
{{--                                        <div>--}}
{{--                                            <label for="question3" class="block text-sm font-medium">--}}
{{--                                                3.What features do you need in your business system?--}}
{{--                                                </label>--}}
{{--                                            <textarea id="question3" wire:model="questions.question3" rows="2"--}}
{{--                                                      class="w-full form-textarea"></textarea>--}}
{{--                                            @error('questions.question3')--}}
...
{{--                                        <!-- Question 5 -->--}}
{{--                                        <div>--}}
{{--                                            <label for="question5" class="block text-sm font-medium">5. 'Do you need support for multiple departments?</label>--}}
{{--                                            <input type="text" id="question5" wire:model="questions.question5"--}}
{{--                                                   class="w-full form-input">--}}
{{--                                            @error('questions.question5')--}}
{{--                                            <span class="text-xs text-red-500">{{$message}}</span>--}}
