<div class=" flex overflow-hidden border rounded-md font-lex">
    ...
    <div class="bg-gray-100 w-full h-60 rounded-r-md gap-y-5">
        <div class="flex justify-between items-center px-5 pt-3">
            <div class="w-11/12 line-clamp-1 text-lg uppercase  font-semibold indent-7 ">{{$id}}. {!!  $title !!}</div>
        ...
        <div class="flex items-center justify-between items-center border-l px-5 pb-3">
            <div class="inline-flex items-center gap-x-3">
                <div class="flex items-center gap-x-2 font-semibold">
                    <div class="rounded-full bg-white overflow-hidden w-5 h-5 flex justify-center items-center">
                ...
                <div class="text-xs text-gray-600 px-4">{{$createdAt}} ...
                </div>
            </div>
            <div
                class="   rounded-full text-sm inline-flex items-center gap-x-2 fill-white px-3 py-1 {{$colorPrior}}">
                <svg fill="" width="" height="" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg"
                     class="w-3.5 h-3.5">
        ...
        <div class="bg-white border-t border-l h-40 p-3 space-y-2 flex-col flex justify-between">
            <div
                class="w-9/12 self-start h-[60px] overflow-hidden text-xs  text-gray-700 font-semibold line-clamp-3 leading-relaxed flex-col justify-start items-center">{!! $description !!}</div>
            <div class="space-y-2">
                <div class=" flex justify-between items-center ">
                    <div class="inline-flex items-center gap-x-2 text-red-600 font-semibold ">
                        ...
                        <div class="text-gray-600 text-xs px-2">{{  $updatedAt }}</div>
                    </div>
                </div>
                <div class=" left-4 w-full flex justify-between items-center self-end  ">
                    ...
                    <div
                        class="text-xs px-3 py-1 rounded-full text-center {{$colorStatus}}">{{$status}}</div>
